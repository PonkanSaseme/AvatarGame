...
public class hairSwitcherB : MonoBehaviour
{
    ...
    void Start()
    {
        LoadSpritesFromStreamingAssetsBHairs();
    }

    void LoadSpritesFromStreamingAssetsBHairs()
    {
        string streamingAssetsPath = Application.streamingAssetsPath;
        streamingAssetsPath = Path.Combine(streamingAssetsPath, "hairsB");
